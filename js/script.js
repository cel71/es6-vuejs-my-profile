...
userDetailHtml = document.querySelector(".user-details")
...
let nuovoPostButton = document.querySelector(".send");
let nuovoPost = document.querySelector(".nuovo-post").value;

nuovoPostButton.addEventListener("click", () => {
    data.myProfile.posts.push ({
        text: nuovoPost.value,
        date: '26-06-2021',
    });
    ...
    <div class="post-details"> 
        ...
        <div class="details">
            <div class="user-name">${data.myProfile.details.name} ${data.myProfile.details.surname}</div>
            <div class="post-date">${data.myProfile.posts.date}</div>
        </div>
    </div> 
    <div class="post-text">
        ${nuovoPost}
